...
%% Construct the MDP
Transition=parse_transition_ltl();%Transition(from,to,act)=p(from,act,to)
...
M.CONTROLSTRING{1} = 'a0r'; M.CONTROLSTRING{3} = 'a2r'; M.CONTROLSTRING{5} = 'a0h'; M.CONTROLSTRING{7} = 'a2h';
M.CONTROLSTRING{2} = 'a1r'; M.CONTROLSTRING{4} = 'a3r'; M.CONTROLSTRING{6} = 'a1h'; M.CONTROLSTRING{8} = 'a3h'; 
M.CONTROLSTRING{9} = 'reset'; M.CONTROLSTRING{10} = 'repair';
